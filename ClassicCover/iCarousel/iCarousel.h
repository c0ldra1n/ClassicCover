...
@property (nonatomic, assign, getter = isTapShortCutEnabled) BOOL tapShortCutEnabled;
...
- (void)hook_carousel:(iCarousel *)carousel mightSelectItemAtIndex:(NSInteger)index;
